...
import Glide, { GlideOptions } from "@glidejs/glide";
import CardIcon from "./CardIcon";

import {cardData} from "../data/CarouselData.tsx"

const CarouselCard: React.FC = () => {
  useEffect(() => {
    const options: GlideOptions = {
      type: "carousel",
      focusAt: "center",
      perView: 3,
      autoplay: 3000,
    ...
    const slider = new Glide(".glide-06", options).mount();
